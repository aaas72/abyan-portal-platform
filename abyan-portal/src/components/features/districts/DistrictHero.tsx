    ...
    >
      ...
      <div className="relative z-10 p-6 sm:p-8 w-full flex flex-col gap-4 text-right">
        <div className="space-y-1.5 flex flex-col">
          ...
          <span className="text-base sm:text-lg font-normal text-emerald-400 font-abyan-body">
            {district.title}
          </span>
        </div>

        <div className="space-y-2">
          <div className="flex items-center gap-2 text-sm sm:text-base font-normal font-abyan-body">
